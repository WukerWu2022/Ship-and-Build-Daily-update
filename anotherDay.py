...
class AnotherDate(object):
    def __init__(self, ExcelDate, GoogleDate):
    #用于非当日更新
        self.ExcelDate = ExcelDate
        self.GoogleDate = GoogleDate

    def exec_Anotherday(self):
        # 这一段是google的API
        ...
        workbook_excel = app.books.open('D:\BOI Production Data\BOI_DAILY_REPORT_' + self.ExcelDate + '.xlsx')
